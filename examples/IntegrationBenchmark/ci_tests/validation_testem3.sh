...
cleanup() {
  ...
  rm -f ${CI_TEST_DIR}/adept_em3_1e5_e-_ASYNC.csv ${CI_TEST_DIR}/adept_em3_1e5_e-_global.csv \
...
$ADEPT_EXECUTABLE --do_validation --allsensitive --accumulated_events \
                  ...
                  --output_file "adept_em3_1e5_e-_ASYNC1"
...
$CI_TEST_DIR/python_scripts/check_validation.py --file1 ${CI_TEST_DIR}/adept_em3_1e5_e-_ASYNC1.csv \
                                                --file2 ${CI_TEST_DIR}/benchmark_files/g4_em3_10e7_e-.csv \
                                                --n1 1e6 --n2 1e7 --tol 0.01 \
                                                --plot_file plot_ASYNC.png # uncomment to plot the validation plot
